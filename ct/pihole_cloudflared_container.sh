...
while true; do
    printf "This will create a new Pi-hole with cloudflared LXC.\n" 
...
msg "Starting LXC..."
pct start $CTID
pct push $CTID pihole_cloudflared_setup.sh /pihole_cloudflared_setup.sh -perms 755
pct exec $CTID /pihole_cloudflared_setup.sh

IP=$(pct exec $CTID ip a s dev eth0 | sed -n '/inet / s/\// /p' | awk '{print $2}')
info "Successfully created a Pi-hole with cloudflared LXC to $CTID at IP Address ${IP}"
