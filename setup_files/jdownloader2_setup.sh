...
wget -O /etc/systemd/system/jdownloader2.service https://raw.githubusercontent.com/EntenPaule/proxmox-scripts/main/systemd_files/jdownloader2.service &>/dev/null
